...
namespace DAL
{
    public class SanPhamRepository : ISanPhamRepository
    {
        ...
        public List<SanPhamModel> SanPhamGetAll(int pageIndex, int pageSize, out long total)
        {
            ...
            try
            {
                var dt = _dbHelper.ExecuteSProcedureReturnDataTable(out msgError, "sp_sanpham_get_all_admin",
        ...
        public SanPhamModel SanPhamGetbyID(int id)
        {
            ...
            try
            {
                var dt = _dbHelper.ExecuteSProcedureReturnDataTable(out msgError, "sp_sanpham_get_by_id_admin",
                     "@MaSP", id);
                if (!string.IsNullOrEmpty(msgError))
                    throw new Exception(msgError);
        ...
        public bool Create(SanPhamModel model)
        {
            ...
            try
            {
                ...
                "@MaDSP", model.MaDSP,
                "@listthongsokythuat", model.listjson_thongsokythuat != null ? MessageConvert.SerializeObject(model.listjson_thongsokythuat) : null);
