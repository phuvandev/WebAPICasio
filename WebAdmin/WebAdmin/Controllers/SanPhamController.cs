...
namespace WebAdmin.Controllers
{
    ...
    public class SanPhamController : ControllerBase
    {
        ...
        public SanPhamController(ISanPhamBusiness sanphamBusiness, IConfiguration configuration, IUpFileBusiness upfileBusiness)
        {
            _sanphamBusiness = sanphamBusiness;
            _upfileBusiness = upfileBusiness;
            _path = configuration["AppSettings:PATH_SP"];
        }

        [Route("sanpham-get-all")]
        [HttpPost]
        public ResponseModel SanPhamGetAll([FromBody] Dictionary<string, object> formData)
        {
            ...
            try
            {
                ...
                long total = 0;
                var data = _sanphamBusiness.SanPhamGetAll(page, pageSize, out total);
